  <?php defined('BASEPATH') or exit('No direct script access allowed');
        ...
        /*function get_service_whycoz()
    {
      ...
      return false;
        ...
        {
            $this->db->select('h.whytitle,h.title,h.short_description,h.significant_1,h.significant_2,h.significant_3,h.significant_4 ,h.significant_5 ,h.significant_6,h.significant_1_desc,h.significant_2_desc,h.significant_3_desc,h.significant_4_desc,h.significant_5_desc,h.significant_6_desc,i.image,i.alt_text');
            $this->db->order_by('h.orderby', 'asc');
        ...
        function get_home_section7()
        {
            $this->db->select('h.title,h.description,h.ctabtn,h.ctalink,h.section_one_title,h.section_one_desc,h.section_two_title,h.section_two_desc,h.section_three_title,h.section_three_desc,si.image as section_one_img,ti.image as section_two_img,oi.image as section_three_img');
            $this->db->order_by('h.id', 'asc');
            $this->db->from('home_section7 h');
            $this->db->join('images_master si', 'si.id=h.section_one_img', 'left');
            $this->db->join('images_master ti', 'ti.id=h.section_two_img', 'left');
            $this->db->join('images_master oi', 'oi.id=h.section_three_img', 'left');
            $qry = $this->db->get();
            if ($qry->num_rows() > 0) {
                return $qry->result_array();
            }
        ...
        function get_home_section8()
        {
            $this->db->select('title,description,ctabtn,ctalink,question_ans');
            $this->db->order_by('id', 'asc');
            $this->db->from('home_section8');
            $qry = $this->db->get();
            if ($qry->num_rows() > 0) {
                return $qry->result_array();
            }
        ...
        /*function getimagebyid($id)
    {
      ...
      return $qry->row_array();
        ...
        function getinnerservicebyslug($slug)
        {
            ...
            $this->db->select('t.*,i.image as inner_banner_image ,i.alt_text as alt_text_banner, m.image as industriesimage ,j.image as inner_banner_mimage, k.image as about_image,k.alt_text as about_alt_text, l.image as advantage_image,l.alt_text as advantage_alt_text,n.image as section11_one_img,o.image as section11_two_img,p.image as section11_three_img,q.image as section12_image,r.image as section12_mimage,q.alt_text as alt_text_section12,r.alt_text as alt_text_section12m,n.alt_text as alt_text_section11_one,o.alt_text as alt_text_section11_two,p.alt_text as alt_text_section11_three');
            ...
            $this->db->join('images_master q', 'q.id=t.section12_image', 'left');
            $this->db->join('images_master r', 'r.id=t.section12_mimage', 'left');
