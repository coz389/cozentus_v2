                    ...
                    <div class="col-12">
                        <form class="forms-sample" id="blog-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Significant 1 Description</label>
                                        <input type="text" class="form-control" name="significant_1_desc" value="<?= $significant_1_desc ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Significant 2 Description</label>
                                        <input type="text" class="form-control" name="significant_2_desc" value="<?= $significant_2_desc ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Significant 3 Description</label>
                                        <input type="text" class="form-control" name="significant_3_desc" value="<?= $significant_3_desc ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Significant 4 Description</label>
                                        <input type="text" class="form-control" name="significant_4_desc" value="<?= $significant_4_desc ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Significant 5 Description</label>
                                        <input type="text" class="form-control" name="significant_5_desc" value="<?= $significant_5_desc ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Significant 6 Description</label>
                                        <input type="text" class="form-control" name="significant_6_desc" value="<?= $significant_6_desc ?>">
                                    </div>
                                </div>
                            </div>
