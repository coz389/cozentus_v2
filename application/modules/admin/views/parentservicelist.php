<div class="main-panel">
  <div class="content-wrapper">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Parent Service List</h4>
        <div class="row">
          <div class="col-12">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <!--   <td><input type="checkbox" class="form-check-input featured-service" data-id="<?= $row['id'] ?>" <?=($row['fservice'] == 1) ? "checked" : ""?>></td>
                     -->  <td>
                        <a class="text-primary mr-5" href="<?= base_url('admin/editparentservice/') . $row['id'] ?>"><i class="fa fa-edit"></i></a>
  ...
  <script>
    $('.delete').click(function() {
      ...
      let bclass = $(this);
      $.ajax({
        url: site_url + "admin/parentservice_delete",
        type: "POST",
        data: {
          id: id
        },
