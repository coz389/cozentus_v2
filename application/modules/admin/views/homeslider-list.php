<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body"> <a href="<?= base_url('admin/addhomeslider') ?>" class="float-right"><i class="fa fa-plus
"></i>New Home slider</a>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row['orderby'] ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/edithomeslider/') . $row['id'] ?>" class="text-primary"><i class="fa fa-edit"></i></a>
    ...
    <script>
        $('.delete').click(function() {
            ...
            let bclass = $(this);
            $.ajax({
                url: site_url + "admin/deletehomeslider",
                type: "POST",
                data: {
                    id: id
                },
