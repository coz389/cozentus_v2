          ...
          <div class="col-12">
            <form class="forms-sample " id="service-form">
              <div class="form-group">
               <!-- <label>Title</label> -->
                <input type="hidden" class="form-control" name="card_heading" id="title" value="Industries">
              </div>
              <div class="form-group">
                <!--<label>Slug</label> -->
                <input type="hidden" class="form-control" name="slug" id="slug" value="industries">
              </div>             
              <hr>
