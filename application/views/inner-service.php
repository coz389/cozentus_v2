            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-12">
                    <div class="abt-con">
                        ...
                        <a href="<?= urldecode($pserv['ctalink']) ?>" class="main-btn" data-aos="fade-up"
                    ...
                    <?php } else { ?>
                        <div class="abt-img" data-aos="fade-left" data-aos-duration="1000">
                            <img src="<?= base_url('uploads/images/') . $pserv['advantage_image'] ?>"
                                alt="<?= $pserv['advantage_alt_text'] ?>" style="border-radius: 12px; height: 400px;object-fit: fill;">
                        </div>
                    <?php } ?>
                </div>
            </div>
...
if (!empty($pserv['about_heading'])) { ?>
    <section class="abt-sec sec" style="background: #eeeeee;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5  col-12">
                    <div class="abt-img" data-aos="fade-left" data-aos-duration="1000">
                        <img src="<?= base_url('uploads/images/') . $pserv['about_image'] ?>"
                            alt="<?= $pserv['about_alt_text'] ?>" style="border-radius: 12px;height: 400px;object-fit: fill;">
                    </div>
                </div>
...
<?php } else if (!empty($pserv['cardsecop'])) { ?>
    <section class="solution-sec sec pt-0">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-12">
                <div class="sec-head center" data-aos="fade-up" data-aos-duration="1000">
                    <h2><?= $pserv['cardsecop_heading'] ?></span></h2>
                </div>
                    ...
                    <div class="swiper services-swiper mt-50" data-aos="fade-up" data-aos-duration="1000">
                        <div class="swiper-wrapper">
                            <?php foreach ($pserv['cardsecop'] as $ins) { ?>
                                <div class="swiper-slide">
                                    <a href="<?= $ins['link'] ?>" class="vtr-card-wrapper style-2">
                                        <img src="<?= base_url('uploads/images/') . $ins['image'] ?>"
                                            alt="<?= $ins['alt_text'] ?>">
                                        <div class="con">
                                            <h3><?= $ins['heading'] ?></h3>
                    ...
                    <div class="coz-tab-list">
                        ...
                        foreach ($pserv['buisness_json'] as $buis) { ?>
                            <div class="coz-tab-item <?= $count == 0 ? 'active' : '' ?>" data-tab="<?= $count ?>"
                                data-aos="fade-up" data-aos-duration="1000" style="color: #fff;">
                        ...
                        <div class="coz-tab-panel <?= $count == 0 ? 'active' : '' ?>" data-panel="<?= $count ?>">
                            ...
                            <div class="panel-content">
                                <h3 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                                    <?= html_entity_decode($buis['heading']) ?></h3>
                                <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                                    <?= html_entity_decode($buis['description']) ?></p>
                                            ...
                                            <div class="col-lg-5 col-12">
                                                <div class="dash-img" data-aos="fade-right" data-aos-duration="1000">
                                                    <img src="<?= base_url('uploads/images/') . $mb['image'] ?>"
                                                        class="img-full" alt="" style="border-radius: 12px;" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12 offset-lg-1" data-aos="fade-left" data-aos-duration="1000">
                                                <div class="sec-head">
                                                    <h2><?= $mb['heading'] ?></h2>
                                                </div>
                                                <ul class="point-list">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <div class="coz-tab-list">
                        ...
                        foreach ($pserv['toolbenefits_json'] as $buis) { ?>
                            <div class="coz-tab-item coz-tab-item1 <?= $count == 0 ? 'active' : '' ?>"
                                data-tab="<?= $count ?>" style="color: #000;"
                                data-aos="fade-up" data-aos-duration="1000" style="color: #fff;">
                                <?= html_entity_decode($buis['tab']) ?>
                            </div>
                        <?php $count++;
...
<?php } ?>
<section class="contact-us-sec sec" id="con-sec">
