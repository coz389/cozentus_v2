...
<?php if (!empty($pserv['cardsecop'])) { ?>
    <section class="solution-sec sec pt-5">
        <div class="row justify-content-center">
                ...
                <?php foreach ($pserv['cardsecop'] as $ins) { ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 position-relative">
                        <div class="card border-primary mb-3" style="height: 12rem;">
                            <div class="card-header"><?= $ins['heading'] ?></div>
                            <div class="card-body">
                                <!-- <h5 class="card-title"><?= $ins['heading'] ?></h5> -->
                                <p class="card-text"> <?= $ins['description'] ?></p>
                                <?php if (!empty($ins['link'])) { ?>
                                    <a href="<?= urldecode($ins['link']) ?>" class="">
                                        Read more
                                    </a>
                                <?php } ?>
                            </div>
...
<?php if ($homewhycoz) { ?>
    <section class="solution-sec why-choose  mt-0 pt-5 " id="" style="background: #eeeeee;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="sec-head center" data-aos="fade-up" data-aos-duration="1000">
...
<?php if ($pserv['industries_heading']) {  ?>
    <section class="solution-sec sec pb-0 " id="" style="">
        <div class="container">
                            ...
                            <?php foreach ($pserv['mbanners'] as $mb) { ?>
                                <div class="swiper-slide">
                                    <div class="card new-card" data-aos="fade-up" data-aos-duration="1000">
                                        <img src="<?= base_url('uploads/images/') . $mb['image'] ?>" class="card-img-top" alt="<?= $mb['alt_text'] ??  $mb['heading'] ?>">
                                        <div class="card-body">
                                            <h3 class="card-title"><?= $mb['heading'] ?></h3>
                                            <p class="card-text card-text-clamp"><?= $mb['description'] ?></p>
                                            <!-- <a href="<?= base_url(urldecode($mb['ctalink'])) ?>" class="btn btn-primary"><?= $mb['ctabtn'] ?></a> -->
                                        </div>
                                        <a href="<?= base_url(urldecode($mb['ctalink'])) ?>" class="btn btn-primary" style="width: 120px; margin: 0px 20px 13px 15px;">
                                            <?= $mb['ctabtn'] ?>
                                        </a>
                                    </div>
...
<?php if (!empty($pserv['toolbenefits_json'])) { ?>
    <section style="background: #19405d; padding: 30px 0;" id="why-choose-us">
                ...
                <div class="col-lg-6 col-12" style="position:relative; min-height:400px;">
                    ...
                    foreach ($pserv['toolbenefits_json'] as $buis) { ?>
                        <div class="coz-tab-panel <?= $count == 0 ? 'active' : '' ?>" data-panel="<?= $count ?>">
                            <div class="panel-image" height="300px" data-aos="fade-left" data-aos-duration="1000">
