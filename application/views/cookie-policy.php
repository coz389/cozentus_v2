        ...
        <div class="row align-center">
            <div class="col-lg-12 pr-60 pr-md-15 pr-xs-15 mx-auto">
                <div class="banner-style-three-info text-center">
                    <h2 class="wow fadeInUp">Cookie Policy</h2>
                </div>
            </div>
        ...
        <div class="blog-item-box">
            <div class="row">
                <div>
                    ...
                    Our website, like most others, uses cookies to distinguish you from other users of our website. This helps us to provide you with a good experience when you browse our website and also allows us to improve our site.
                    <br><br>
                    ...
                    <br><br>
                    By using our website you agree that we can place the aforementioned cookies on your device and that it will issue them as soon you visit our site unless you have adjusted your browser setting so that it will refuse cookies.
                </div>
            </div>
        </div>
