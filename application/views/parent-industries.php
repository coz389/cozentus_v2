                ...
                <div class="col-lg-6 col-12">
                    <div class="abt-con">
                        ...
                        <p class="para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                            <?= $pserv['about_short_description'] ?>?
                        </p>
                        <?php if (!empty($pserv['ctalink'])) { ?>

                            <a hrerf="<?= urldecode($pserv['ctalink']) ?>" class="main-btn mb-5" data-aos="fade-up"
                ...
                <div class="col-lg-5 offset-lg-1 col-12">
                    ...
                    <?php } else { ?>
                        <div class="abt-img" data-aos="fade-left" data-aos-duration="1000">
                            <img src="<?= base_url('uploads/images/') . $pserv['advantage_image'] ?>" alt="industries">
                        </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <section class="solution-sec sec pt-0">
        ...
        <div class="container">
            <div class="row justify-content-center mt-3">
                ...
                //  echo "<pre>";
                //  print_r($focus); die();
                foreach ($pserv['focus_json'] as $ins) { ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 position-relative">
                        <span class="g-top"></span>
                        <div class="bdr-sec">
                            <h3><?= $ins['heading'] ?></h3>
                            <p> <?= $ins['description'] ?></p>
                            <?php if (!empty($ins['ctalink'])) { ?>
                                <a href="<?= $ins['ctalink'] ?>" class="">
                                    Read more
                                </a>
                            <?php } ?>
                        </div>
                        <span class="g-bottom"></span>
...
<!-- <section class="info-sec sec use-case">
 <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mt-30">
                    <ul class="nav cc-tabs nav-tabs style-2" id="myTab" role="tablist">
                        <?php

                        $benefits_ct = $pserv['toolbenefits_json'];
                        if (!empty($benefits_ct))
                            foreach ($benefits_ct as $buis) {

                        ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link benefits-tab" id="home-tab" data-bs-toggle="tab"
                                    data-bs-target="#<?= str_replace(' ', '-', $buis['tab']) ?>" type="button" role="tab"
                                    aria-controls="home" aria-selected="true"><?= $buis['tab'] ?></button>
                            </li>
                        <?php   }
                        ?>
                    ...
                    <div class="tab-content" id="">
                        <?php if (!empty($benefits_ct)) {
                            foreach ($benefits_ct as $buis) {
                        ?>

                                <div class="tab-pane fade" id="<?= str_replace(' ', '-', $buis['tab']) ?>" role="tabpanel"
                                    aria-labelledby="home-tab">
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 col-12 text-center img-service">
                                            <img src="<?= base_url('uploads/images/') . $buis['image'] ?>" class=""
                                                alt="<?= $buis['alt_text'] ?>">
                                        </div>
...
?>
<!-- <section class="sec tab-sec pt-0">
 <div class="container">
     <div class="row">
         <div class="col-12">
             <div class="sec-head center" data-aos="fade-up" data-aos-duration="1000">
                 <h2>
                     <?= $pserv['buisness_heading'] ?>
                 </h2>
             </div>
         </div>
         <div class="col-12 mt-30">
             <ul class="nav cc-tabs nav-tabs " id="myTab" role="tablist">
                 <?php
                    $buisness_ct = $pserv['buisness_json'];
                    foreach ($buisness_ct as $buis) {
                    ?>
                         <li class="nav-item" role="presentation">
                             <button class="nav-link business-tab" id="home-tab" data-bs-toggle="tab" data-bs-target="#<?= str_replace([' ', ','], '-', $buis['tab']) ?>" type="button" role="tab" aria-controls="home" aria-selected="true"><?= $buis['tab'] ?></button>
                         </li>
                 <?php              }
                    ?>
             </ul>
             <div class="tab-content" id="myTabContent">
                 <?php if (!empty($buisness_ct)) {
                        foreach ($buisness_ct as $buis) {
                    ?>
                         <div class="tab-pane fade" id="<?= str_replace([' ', ','], '-', $buis['tab']) ?>" role="tabpanel" aria-labelledby="home-tab">
                             <div class="row align-items-center">
                                 <div class="col-lg-5 col-12" >
                                     <img data-aos="fade-right" data-aos-duration="1000" src="<?= base_url('uploads/images/') . $buis['image'] ?>" class="img-full" alt="<?= $buis['alt_text'] ?>">
                                 </div>
                                 <div class="col-lg-6 offset-lg-1 col-12" data-aos="fade-left" data-aos-duration="1000">
                                     <div class="sec-head">
                                         <h2><?= $buis['heading'] ?></h2>
                                     </div>
                                     <p class="para">
             ...
             <div class="col-lg-8">
                 ...
                 <?php $faqArr = json_decode($pserv['card_json_faq'], true);
                    ...
                    ?>
                     <div class="accordion-item" data-aos="fade-up" data-aos-duration="1000">
                         <h2 class="accordion-header" id="headingOne">
                         <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?= $count ?>" aria-expanded="true" aria-controls="collapseOne">
                         <?= $fq['heading'] ?>
                         </button>
                         </h2>
...
?>
    ...
    <!-- <a href="javascript:void(0)" class="main-btn sticky-btnxlsx costsaving-modal">
 <span>Calculate Cost Saving</span>
</a> -->
