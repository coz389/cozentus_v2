...
if (!empty($pserv['inner_banner_image'])) { ?>
    <header class="inner-main-header style-3">
        <picture>
                ...
                <?php foreach ($pserv['cardsecop'] as $ins) { ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 position-relative">
                        ...
                        <div class="bdr-sec">
                            <h3><?= $ins['heading'] ?></h3>
                            <p> <?= $ins['description'] ?></p>
                            <?php if (!empty($ins['link'])) { ?>
                                <a href="<?= $ins['link'] ?>" class="">
                                    Read more
                                </a>
                            <?php } ?>
                        </div>
...
<?php if (!empty($pserv['believe_json'] && !empty($pserv['believe_heading']))) { ?>
    <section class="counter-sec pt-5 sec" style="background: #eeeeee;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="sec-head center" data-aos="fade-up" data-aos-duration="1000">
                        <h2><?= $pserv['believe_heading'] ?></h2>
                    </div>
                    <div class="counter-container mt-40">
                        ...
                        ?>
                            <div class="counter-card style-2" data-aos="fade-up" data-aos-duration="1000">
                                <h2 class="counter"><?= $belp['key'] ?></h2>
                                <p>
                                    <?= $belp['value'] ?>
                                </p>
                            </div>
