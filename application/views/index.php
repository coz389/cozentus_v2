                ...
                <div class="row align-center">
                    <div class="col-xl-8 offset-xl-2">
                        <div class="banner-one-content fade-up-anim">
                            <h4>Smart Technology Partner</h4>
                            <!-- <h2><strong style="background-image: url(assets/img/shape/banner-2.jpg);">AI-Powered </strong> Custom Tech Logistics Solutions</h2> -->
                            <!-- <h2><?= html_entity_decode($banners[0]['title']) ?></h2>   assets/img/shape/banner-2.jpg-->
                            <h2><span id="sliding-text"></span> <?= html_entity_decode($banners[0]['title']) ?></h2>
                            <div class="content">
                                <p>
                                    <?= html_entity_decode($banners[0]['short_description']) ?>
                                </p>
                                <?php if (!empty($banners[0]['cta_btn']) && !empty($banners[0]['cta_link'])) { ?>
                                    <div class="button mt-30">
                                        <a href="<?= urldecode($banners[0]['cta_link']) ?>" class="btn btn-style-one light"><?= $banners[0]['cta_btn'] ?> <i class="fas fa-arrow-right"></i></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
