...
<div id="smooth-content">
    ...
    <?php if (!empty($banners)) { ?>
        <div class="homepage-carousel swiper">
            <!-- Additional required wrapper -->
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-box">
                        <img src="<?= base_url('assets/img/shape/banner-18.jpg') ?>" alt="Image Not Found">
                ...
                <div class="swiper-slide">
                    <div class="banner-box">
                        <img src="<?= base_url('assets/img/shape/banner-17.jpg') ?>" alt="Image Not Found">
                        <div class="banner-content">
                ...
                <div class="swiper-slide">
                    <div class="banner-box">
                        <img src="<?= base_url('assets/img/shape/banner-5.jpg') ?>" alt="Image Not Found">
                        <div class="banner-content">
                ...
                <div class="swiper-slide">
                    <div class="banner-box">
                        <img src="<?= base_url('assets/img/shape/banner-6.jpg') ?>" alt="Image Not Found">
                        <div class="banner-content">
                            <h1>AI-Powered Custom Tech For Supply Chain Logistics</h1>
                            <p>Innovative solutions that combine AI Agents, Gen-AI, IDP, Data Engineering, and Scalable Cloud Integrations to create a foundation of sustainable growth.</p>
                            <div class="button mt-30 d-block text-center">
